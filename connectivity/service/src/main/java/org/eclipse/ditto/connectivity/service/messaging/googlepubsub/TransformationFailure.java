...
/**
 * Represents a failed transformation of a Google Pub/Sub {@code ReceivedMessage}.
 *
...
public final class TransformationFailure<I, O> extends TransformationResult<I, O> {
    ...
    private final GooglePubSubTransformationException error;

    private TransformationFailure(final I transformationInput, final GooglePubSubTransformationException error) {
    ...
    public static <I, O> TransformationFailure<I, O> of(final I transformationInput,
                                                        final GooglePubSubTransformationException error) {
    ...
    @Override
    public GooglePubSubTransformationException getErrorOrThrow() {
        return error;
    }
